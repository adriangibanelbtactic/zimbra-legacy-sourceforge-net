			...
			items: [
				{type:_GROUP_,	numCols:4,colSizes:["32px","350px","100px","250px"],
					items: [
						...
						{type:_OUTPUT_, ref:ZaPosixGroup.A_cn, label:null,cssClass:"AdminTitle", rowSpan:2},				
						{type:_OUTPUT_, ref:ZaPosixGroup.A_gidNumber, label:"gidNumber"}
					]
				}
			],
				...
				{type:_ZATABCASE_, relevant:"instance[ZaModel.currentTab] == 1", 
					...
					items:[
						...
						{ref:ZaPosixGroup.A_memberUid,
							...
							items: [
								{ref:".", type:_TEXTFIELD_, label:null, onChange:ZaTabView.onFormFieldChanged,cssClass:"admin_xform_name_input"}
							],
